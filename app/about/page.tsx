  ...
  return (
    <div className="bg-[#FBF8F3]">
      ...
      <section className="py-16 md:py-24 max-w-5xl mx-auto px-6 text-center space-y-6 md:space-y-8">
        ...
        <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-light text-[#322C2B] leading-tight max-w-4xl mx-auto">
        ...
        <p className="font-body text-lg md:text-xl text-[#6E655E] max-w-3xl mx-auto font-light leading-relaxed">
      ...
      <section className="py-16 bg-[#F2ECE3]/30 border-y border-[#F2ECE3]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          <div className="lg:col-span-5 flex justify-center">
            {/* Elegant Arch Frame */}
            <div className="relative w-full max-w-[340px] aspect-[3/4] rounded-t-full border border-[#C8852E]/20 p-2.5 bg-white shadow-xl overflow-hidden">
      ...
      <section className="py-24 max-w-6xl mx-auto px-6 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {beliefs.map((belief, idx) => (
            <div 
              key={idx} 
              className="bg-white border border-[#F2ECE3] shadow-md hover:shadow-lg rounded-xl p-8 space-y-4 transition-all duration-300"
            >
              <div className="w-8 h-8 rounded-full bg-[#C8852E]/10 flex items-center justify-center text-[#C8852E] font-mono text-xs">
                0{idx + 1}
              </div>
      ...
      <section className="py-20 bg-[#2C4A47] text-white">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-6">
          ...
          <p className="font-body text-sm md:text-base text-[#FBF8F3]/85 font-light leading-relaxed max-w-2xl mx-auto">
          ...
          <p className="font-display italic text-[#D9A38A] text-xl md:text-2xl pt-2">
      ...
      <section className="py-24 max-w-4xl mx-auto px-6 space-y-12">
        <div className="text-center space-y-3">
          ...
          <p className="font-body text-sm text-[#6E655E] uppercase font-light tracking-wide">
        ...
        <div className="text-center text-xs text-[#6E655E] italic max-w-sm mx-auto leading-relaxed">
