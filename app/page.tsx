...
export default function HomePage() {
  ...
  return (
    <div className="relative overflow-hidden">
          ...
          >
            ...
            >
              <button
                ...
                className="bg-[#C8852E] hover:bg-[#9E6418] text-white font-body text-sm px-8 py-4 rounded-full transition-all tracking-wide text-center cursor-pointer shadow-md hover:shadow-lg inline-flex items-center justify-center gap-2 font-medium"
              >
              ...
              <Link
                href="/retreats"
                className="border border-[#C8852E]/30 text-[#322C2B] hover:border-[#C8852E] hover:bg-white/40 font-body text-sm px-8 py-4 rounded-full transition-all tracking-wide text-center inline-flex items-center justify-center gap-2 font-light"
              >
                Explore Retreats
      ...
      <section className="py-24 bg-[#F2ECE3]/50 relative border-y border-[#F2ECE3]">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
      ...
      <section className="bg-[#2C4A47] text-white py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-start">
            ...
            <div className="relative w-full max-w-[340px] aspect-[4/5] rounded-t-full border border-[#D9A38A]/30 p-2 overflow-hidden shadow-2xl">
              <div className="w-full h-full relative rounded-t-full overflow-hidden">
                <img
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-4 font-body text-base text-[#FBF8F3]/90 font-light leading-relaxed">
            ...
            <div className="pt-4">
              <Link
                href="/about"
                className="bg-[#D9A38A] hover:bg-[#C8852E] text-[#2C4A47] hover:text-white font-body text-sm px-8 py-3.5 rounded-full transition-all tracking-wide inline-flex items-center gap-2 font-medium"
              >
                Read my full story 
      ...
      <section className="py-24 bg-[#FBF8F3] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-[#6E655E] font-body text-base font-light leading-relaxed">
              <p>
          ...
          <div className="bg-[#F2ECE3]/40 border border-[#F2ECE3] rounded-2xl p-8 md:p-10 space-y-6 relative">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            {[
              ...
              <div 
                key={idx} 
                className="bg-white border border-[#F2ECE3] shadow-lg shadow-[#322C2B]/5 rounded-xl p-8 relative flex flex-col justify-between items-start hover:-translate-y-1 transition-all duration-300"
              >
      ...
      <section className="py-24 bg-[#FBF8F3]">
        <div className="max-w-6xl mx-auto px-6 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            {/* THIS IS FOR YOU IF */}
            <div className="bg-white border border-[#F2ECE3] rounded-2xl p-8 md:p-10 shadow-lg shadow-[#322C2B]/5 border-t-4 border-t-[#C8852E] space-y-6">
            ...
            {/* NOT FOR YOU */}
            <div className="bg-white border border-[#F2ECE3] rounded-2xl p-8 md:p-10 shadow-lg shadow-[#322C2B]/5 border-t-4 border-t-[#6E655E] space-y-6">
              <div className="flex items-center gap-3">
