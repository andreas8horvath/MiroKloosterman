    ...
    <div className="bg-[#FBF8F3]">
      ...
      <section className="py-24 max-w-5xl mx-auto px-6 space-y-16">
        <div className="text-center space-y-3">
          ...
          <p className="font-body text-sm text-[#6E655E] italic">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {stages.map((stg, idx) => (
            <div 
              key={idx} 
              className="bg-white border border-[#F2ECE3] rounded-xl p-8 space-y-4 shadow-sm hover:border-[#C8852E]/30 transition-all"
            >
